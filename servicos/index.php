...
// Segurança ajustada para o caminho da raiz
...
// Consulta ajustada para a tabela 'servicos'
...
$total_servicos = count($resultado);
    ...
    <div class="layout-dashboard">
        ...
        <main>
            ...
            <div class="acao-criar">
                <a href="create.php" class="btn btn-principal">➕ Novo Serviço</a>
            </div>
            ...
            <?php if ($total_servicos > 0): ?>
                        ...
                        <tbody>
                            <?php foreach ($resultado as $servico): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="acoes">
                                            <a href="update.php?id=<?php echo $servico['id']; ?>" class="btn btn-editar btn-pequeno">✏️ Editar</a>
                                            <a href="delete.php?id=<?php echo $servico['id']; ?>" class="btn btn-deletar btn-pequeno" onclick="return confirm('Tem certeza que deseja deletar este serviço?');">🗑️ Deletar</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <p style="margin-top: 20px; color: #b0b0b0;"> <strong>Total de serviços:</strong> <?php echo $total_servicos; ?></p>
            <?php else: ?>
